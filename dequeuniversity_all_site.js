...
async function runExample() {
    try {
        ...
        const result = await pa11y('https://dequeuniversity.com/demo/mars/', {
        ...
        fs.writeFile(`test_result/Test_dequeuniversity_full_site_${testDateTime}.html`, html, (err) => { // создаем файл "result.html" и записываем в него данные
            if (err) throw err;
        ...
        fs.writeFile(`test_result/Test_dequeuniversity_full_site_${testDateTime}.csv`, csv, (err) => {
            if (err) throw err;
