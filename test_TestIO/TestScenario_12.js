    ...
    try {
        ...
        const result = await pa11y('https://tester.test.io/', {
            ...
            actions: [
                ...
                "click element a[class='testio-nav-item hidden-xs-down pb-0'] span[class='icon icon-cog mr-0']",
                'wait for url to be https://tester.test.io/account/profile',
                "click element a[href='/testers/727140/notification_settings/edit']",
                'wait for url to be https://tester.test.io/testers/727140/notification_settings/edit',
