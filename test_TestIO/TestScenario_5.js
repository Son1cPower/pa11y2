...
async function runExample() {
    ...
    try {
        ...
        const result = await pa11y('https://tester.test.io/', {
            ...
            rootElement: "iframe[title='Intercom live chat'][name='intercom-messenger-frame']",
            ...
            actions: [
                ...
                "click element div[aria-label='Open Intercom Messenger']",
                "wait for element iframe[title='Intercom live chat'][name='intercom-messenger-frame'] to be visible",
            ],
